      ...
      <Form.Item label="Add Photos">
        ...
        <div className="grid grid-cols-4 gap-10">
          <div
            ...
            className="border rounded-lg p-10 cursor-pointer flex justify-center items-center text-primary"
          >
          ...
          <div
            onClick={() => widgetRef2?.current?.openDialog("")}
            className="border rounded-lg p-10 cursor-pointer flex justify-center items-center text-primary"
          >
            <FaCloudUploadAlt className="text-3xl" />
            <span className="hidden">
          ...
          <div
            onClick={() => widgetRef3?.current?.openDialog("")}
            className="border rounded-lg p-10 cursor-pointer flex justify-center items-center text-primary"
          >
            <FaCloudUploadAlt className="text-3xl" />
            <span className="hidden">
          ...
          <div
            onClick={() => widgetRef4?.current?.openDialog("")}
            className="border rounded-lg p-10 cursor-pointer flex justify-center items-center text-primary"
          >
            <FaCloudUploadAlt className="text-3xl" />
            <span className="hidden">
