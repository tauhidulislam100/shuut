              ...
              <div className="w-full mt-4" key={message?.id}>
                ...
                <div className="lg:w-4/5 flex">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="flex justify-end text-xs font-sofia-pro text-[#0A242980]">
                      {format(
                        new Date(message.created_at),
                        "MMM dd yyyy, hh:mm"
                      )}
                    </div>
                    <div className="w-full mt-1 space-x-2 flex justify-end items-center gap-1 md:font-medium md:text-sm text-xs font-sofia-pro">
